...
export const components = {
  ...
  nosotros_hero: dynamic(() => import("./NosotrosHero")),
  nosotros_mapa: dynamic(() => import("./NosotrosMapa")),
  nosotros_slider: dynamic(() => import("./NosotrosSlider")),
  nosotros_valores: dynamic(() => import("./NosotrosValores")),
  ...
  unete_al_equipo: dynamic(() => import("./UneteAlEquipo")),
};
